...
ConVar g_check, g_haway, g_hdaze, g_hkick, g_hsset, g_hmaxs, g_hLimit, g_hTeam, g_health, g_hSteam, g_hBanId;

int g_iSurvivorBot, userids, maxplayers;
int hgive0, hgive1, hgive2, hgive3, hgive4, hgive5;
int hcheck, hdaze, haway, hkick, hsset, hmaxs, hLimit, hTeam, health, hSteam, hBanId;
